...
// Custom event listener for slide changes
...
Reveal.addKeyBinding({ keyCode: 66, key: 'B', description: 'Toggle pause (Blank screen)' }, () => {
    Reveal.configure({ backgroundTransition: 'fade' });
    const currentSlide = Reveal.getCurrentSlide();
    currentSlide.style.opacity = currentSlide.style.opacity === '0' ? '1' : '0';
});
